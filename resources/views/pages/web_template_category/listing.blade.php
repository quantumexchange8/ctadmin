                ...
                <div class="col-lg-12 layout-spacing">
                    <div class="statbox widget box box-shadow">
                        <div class="widget-content widget-content-area">
                            <form method="POST" action="{{ route('web_template_category_listing') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($records as $record)
                                            <tr>
                                                <td>{{ $no }}</td>
                                                <td>
                                                    @if($record->hasMedia('web_template_category_images'))
                                                        <img class="m-auto p-auto rounded-circle avatar bg-white" src="{{ $record->getFirstMediaUrl('web_template_category_images') }}"/>
                                                    @else
                                                        <img class="m-auto p-auto bg-white rounded-circle avatar" src="{{Vite::asset('resources/images/ct-logo.png')}}" />
                                                    @endif
                                                </td>
                                                <td>{{ $record->web_template_category_name }}</td>
