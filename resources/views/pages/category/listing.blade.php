                        ...
                        <div class="widget-content widget-content-area">
                            <form method="POST" action="{{ route('category_listing') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            <label for="search_visibility" class="mb-2">@lang('public.status')</label>
                                            {!! Form::select('category_status', $get_status_sel, @$search['category_status'], ['class' => 'form-select', 'placeholder' => trans('public.search_visibility')]) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                ...
                ?>
                    <div id="tableWithoutBorder" class="col-lg-12 col-12 layout-spacing">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                <p class="mb-4"> @lang('public.add_categories_caption')</p>
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col">@lang('public.slug')</th>
                                            <th class="text-center" scope="col">@lang('public.caption')</th>
                                        ...
                                        @foreach($records as $record)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span class="badge {{ $record->category_status == 1 ? 'badge-light-success' : "badge-light-secondary" }}">{{ $record->category_status == 1 ? trans('public.visible') : trans('public.not_visible') }}</span>
                                                </td>
                                                <td class="text-center">
                                                    <div class="action-btns">
                                                        <a href="{{ route('category_edit', $record->id) }}" class="action-btn btn-edit bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="@lang('public.edit')">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
                                                        </a>
                                                        <a href="javascript:void(0);" class="action-btn btn-delete bs-tooltip delete" data-id='{{ $record->id }}' data-toggle="tooltip" data-placement="top" title="@lang('public.delete')" data-bs-toggle="modal" data-bs-target="#category_delete">
                    ...
                    <div class="modal-content">
                        <form method="POST" action="{{ route('category_delete') }}">
                            ...
                            <div class="modal-body text-center">
                                ...
                                <p class="modal-text">@lang('public.category_delete')</p>
