...
$prefixRouters = [
    'modern-light-menu', 'modern-dark-menu'
];

foreach ($prefixRouters as $prefixRouter) {
    Route::prefix($prefixRouter)->middleware(['auth', 'isAdmin'])->group(function () {
        ...
        Route::prefix('product')->group(function () {
            Route::match(['get', 'post'], '/product_add', [ProductController::class, 'product_add'])->name('product_add');
            Route::match(['get', 'post'], '/product_listing', [ProductController::class, 'product_listing'])->name('product_listing');
            Route::match(['get', 'post'], '/product_edit/{id}', [ProductController::class, 'product_edit'])->name('product_edit');
            Route::post('/product_upload', [ProductController::class, 'product_upload']);
            Route::delete('/product_image_delete', [ProductController::class, 'product_image_delete']);
            Route::post('/product_delete', [ProductController::class, 'product_delete'])->name('product_delete');
        });
        ...
        Route::prefix('category')->group(function () {
            Route::match(['get', 'post'], '/category_add', [CategoryController::class, 'category_add'])->name('category_add');
...
//            Route::post('/category_delete', [CategoryController::class, 'category_delete'])->name('category_delete');
        ...
        /**
         * ==============================
         *        @Router -  Expert Advisor
         * ==============================
         */

        Route::prefix('expert_advisor')->group(function () {
//            Route::match(['get', 'post'], '/web_template_category_add', [WebTemplateController::class, 'web_template_category_add'])->name('web_template_category_add');
//            Route::post('/web_template_category_upload', [WebTemplateController::class, 'web_template_category_upload']);
//            Route::match(['get', 'post'], '/web_template_category_listing', [WebTemplateController::class, 'web_template_category_listing'])->name('web_template_category_listing');
        });
        ...
        Route::prefix('pos_system')->group(function () {
//            Route::match(['get', 'post'], '/web_template_category_add', [WebTemplateController::class, 'web_template_category_add'])->name('web_template_category_add');
//            Route::post('/web_template_category_upload', [WebTemplateController::class, 'web_template_category_upload']);
//            Route::match(['get', 'post'], '/web_template_category_listing', [WebTemplateController::class, 'web_template_category_listing'])->name('web_template_category_listing');
        });
        ...
        Route::prefix('web_template_category')->group(function () {
            ...
            Route::delete('/web_template_category_image_delete', [WebTemplateCategoryController::class, 'web_template_category_image_delete']);
            Route::match(['get', 'post'], '/web_template_category_edit/{id}', [WebTemplateCategoryController::class, 'web_template_category_edit'])->name('web_template_category_edit');
            Route::post('/web_template_category_delete', [WebTemplateCategoryController::class, 'web_template_category_delete'])->name('web_template_category_delete');
        });
